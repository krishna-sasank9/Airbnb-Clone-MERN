  ...
  return (
    <>
        <label className="border p-4 flex rounded-xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('wifi')} name='wifi' type="checkbox" onChange={handleBoxClick} />
                <svg
              ...
              <label className="border p-4 flex rounded-xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('parking')} name='parking' type="checkbox" onChange={handleBoxClick} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('tv')} name='tv' type="checkbox" onChange={handleBoxClick} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('radio')} name='radio' type="checkbox" onChange={handleBoxClick} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('pets')} name='pets' type="checkbox" onChange={handleBoxClick} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('entrance')} name='entrance' type="checkbox" onChange={handleBoxClick} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
